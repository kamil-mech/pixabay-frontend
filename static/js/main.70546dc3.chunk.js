...
`;var Ut=()=>{var e,t;const a=+(null!==(e=null===(t=Object(o.f)().params.photoSlug)||void 0===t?void 0:t.split("-").reverse()[0])&&void 0!==e?e:""),{imageDetails:c,...s}=Ue({id:a});return Object(i.jsx)(ae,{children:Object(i.jsx)(Rt,{children:Object(i.jsx)(Le,{...s,children:c&&Object(i.jsx)(Ot,{imageDetails:c})})})})};var Lt=()=>{const{t:e}=Object(x.a)();return Object(c.useEffect)((()=>{document.title=e("error-404")})),Object(i.jsx)(ae,{children:Object(i.jsx)(M,{children:e("page-not-found")})})},_t=a(50),kt=a(48),Ht=a(49),$t=a(21);_t.a.use(kt.a).use(Ht.a).use($t.e).init({backend:{loadPath:"/locales/{{lng}}/translation.json"},whitelist:["en","de"],fallbackLng:"en",detection:{order:["querystring","navigator"],lookupQuerystring:"lng",checkWhitelist:!0},react:{wait:!0,useSuspense:!1}});const Mt=l.b`
  html {
...
//# sourceMappingURL=main.70546dc3.chunk.js.map